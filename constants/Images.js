...
const Logo = require('../assets/imgs/logo_mini.png');
const ProfileBackground = require('../assets/imgs/snatched2.jpg');
const RegisterBackground = require('../assets/imgs/getPro-bg-1.png');
const Pro = require('../assets/imgs/bg.png');
const NowLogo = require('../assets/imgs/logo.png');
const iOSLogo = require('../assets/imgs/ios.png');
const androidLogo = require('../assets/imgs/android.png');
const ProfilePicture = require('../assets/imgs/snatched.jpg');
